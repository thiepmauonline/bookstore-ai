...
<th scope="col">Slug (Đường dẫn SEO)</th>
            ...
            <div class="modal-content">
                <form wire:submit="{{ $isEditMode ? 'update' : 'store' }}">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $isEditMode ? 'Cập nhật' : 'Thêm mới' }} Danh mục</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                                ...
                                <label class="form-label">Slug (Đường dẫn SEO) <span class="text-danger">*</span></label>
