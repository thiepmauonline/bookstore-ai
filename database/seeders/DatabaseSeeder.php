...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // Cố định bộ sinh số ngẫu nhiên để mỗi lần seed ra cùng một bộ dữ liệu (tiện chụp màn hình báo cáo).
        mt_srand(2026);
        ...
        // 8. Dữ liệu vận hành mẫu: khách hàng, đơn hàng, mã giảm giá, đánh giá, chatbot...
